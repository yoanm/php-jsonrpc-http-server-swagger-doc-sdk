Feature: Error normalization
  ...
  Scenario: Simple error normalization for server errors
    ...
    And normalized definition named "ServerError-My-error123" should be the following:
    """
    {
      "title": "my-error",
      "allOf": [
  ...
  Scenario: Simple error normalization for global server errors
    ...
    When I normalize server doc
    Then I should have a normalized definition named "Error-My-error123"
    And normalized definition named "Error-My-error123" should be the following:
    """
    {
      "title": "my-error",
      "allOf": [
  ...
  Scenario: Fully configured error normalization for server errors
    ...
    And I append last error doc to server errors
    When I normalize server doc
    Then I should have a normalized definition named "ServerError-ErrorIdentifier-test"
    And normalized definition named "ServerError-ErrorIdentifier-test" should be the following:
    """
    {
      "title": "my-error",
      "allOf": [
  ...
  Scenario: Fully configured error normalization for global server errors
    ...
    And I append last error doc to global server errors
    When I normalize server doc
    Then I should have a normalized definition named "Error-ErrorIdentifier-test"
    And normalized definition named "Error-ErrorIdentifier-test" should be the following:
    """
    {
      "title": "my-error",
      "allOf": [
